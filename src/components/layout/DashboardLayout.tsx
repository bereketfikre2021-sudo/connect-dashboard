    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 lg:ml-60 flex flex-col overflow-hidden min-w-0">
        ...
        <header className="shrink-0 flex items-center gap-2 px-4 py-3 border-b border-gray-800 bg-gray-950/80 backdrop-blur-sm">
          ...
          {/* Search trigger — desktop shows shortcut hint, mobile shows icon only */}
          <button
            onClick={() => setPaletteOpen(true)}
            className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-800/60 border border-gray-700/50 hover:border-gray-600 text-gray-500 hover:text-gray-300 transition-colors text-sm"
          ...
          >
            ...
            <kbd className="hidden sm:inline text-[11px] bg-gray-700 px-1.5 py-0.5 rounded font-mono ml-1">⌘K</kbd>
          </button>
